(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-rewievs")) new core(".swiper-rewievs", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    const filterBox = document.querySelectorAll(".filter-hover");
    document.querySelector(".filter-container").addEventListener("click", (event => {
        ...
        filterBox.forEach((elem => {
            ...
            if (!elem.classList.contains(filterClass) && "all" !== filterClass) elem.classList.add("filter-hide");
        }));
    }));
    window["FLS"] = true;
    isWebp();
